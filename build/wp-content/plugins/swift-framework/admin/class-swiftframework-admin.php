	  ...
	  ?>
		<div class="sf-about-wrap">
			...
			<div class="about-content">
				...
				<h3>Latest Update (v2.5.43)</h3>
				<p></p>
				<ul>
					<li>BACKEND: Fixed page builder formatting issue when saving content with WordPress 4.8.</li>
				</ul>
				<div class="divide"></div>
				<h3>Previous Update (v2.5.42)</h3>
				<p></p>
				<ul>
					<li>FRONTEND: Update matchHeights js script to fix column matched height issues.</li>
					<li>FRONTEND: Fixed blog social integration.</li>
					<li>FRONTEND: Fixed CSS issue with older browsers.</li>
					<li>BACKEND: Fixed page builder issue when saving content with WordPress 4.8.</li>
				</ul>
			</div>
		</div>
	  <?php
