...
<?php if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" method="post" enctype='multipart/form-data'>
	 	...
	 	<button type="submit" data-product_id="<?php echo esc_attr($product_id); ?>" data-quantity="<?php echo esc_attr( $minimum_allowed_quantity ); ?>" data-default_text="<?php echo esc_attr($product->single_add_to_cart_text()); ?>" data-default_icon="sf-icon-add-to-cart" data-loading_text="<?php echo esc_attr($loading_text); ?>" data-added_text="<?php echo esc_attr($added_text); ?>" class="<?php echo $button_class; ?> ajax_add_to_cart product_type_simple button alt"><?php echo apply_filters('sf_add_to_cart_icon', '<i class="sf-icon-add-to-cart"></i>'); ?><span><?php echo esc_attr($product->single_add_to_cart_text()); ?></span></button>
